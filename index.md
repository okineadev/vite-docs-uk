---
title: Vite
titleTemplate: Інструменти фронтенду наступного покоління
...
<div class="VPHome">
  <Hero/>
  <FeatureSection title="Переосмислення досвіду розробника" description="Vite робить веб-розробку знову простою" type="blue">
    <FeatureInstantServerStart />
    <FeatureHMR />
    <FeatureRichFeatures />
    <FeatureOptimizedBuild />
  </FeatureSection>
  <FeatureSection title="Спільна основа для побудови" type="pink" class="feature-section--flip">
