...
<template>
  ...
  >
    ...
    <div class="feature__meta">
      <div class="meta__title">Гнучка система плагінів</div>
      <div class="meta__description">
        Плагіни Vite розширюють добре продуманий інтерфейс плагінів Rollup з кількома додатковими опціями, специфічними для Vite.
      </div>
    </div>
  </div>
</template>
