...
<template>
  ...
  >
    ...
    <div class="feature__meta meta--center">
      <div class="meta__title">Безперервна інтеграція екосистеми</div>
      <div class="meta__description">
        Наша система CI постійно тестує зміни у Vite на сумісність з іншими проєктами, що дозволяє нам покращувати Vite зі стабільністю та впевненістю.
      </div>
    </div>
  </div>
</template>
