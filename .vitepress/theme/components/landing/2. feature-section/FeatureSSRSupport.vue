...
<template>
  ...
  >
    ...
    <div class="feature__meta">
      <div class="meta__title">Підтримка SSR першого класу</div>
      <div class="meta__description">
        Ще ніколи не було так легко налаштувати власний SSR (серверний рендеринг) або створити свій власний SSR фреймворк.
      </div>
    </div>
  </div>
</template>
