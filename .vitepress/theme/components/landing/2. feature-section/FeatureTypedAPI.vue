      ...
      <div class="tooltip">
        <span class="code">
          ...
          ><span class="code--blue">&lt;</span>ViteDevServer<span
            ...
            >&gt;</span
          ><br />
            <span class="code--descriptor">Запустити сервер.</span>
        </span>
      </div>
    </div>
    <div class="feature__meta meta--center">
      <div class="meta__title">Повністю типізований API</div>
      <div class="meta__description">Створений для розширення та побудови на його основі.</div>
    </div>
  </div>
</template>
