  ...
  <div class="hero">
    <div class="container">
      ...
      >
        ...
        <span>Доповіді ViteConf 2024</span>
      </a>

      <!-- Heading -->
      <h1>Інструмент збірки<br />для Вебу</h1>
      <!-- Tagline -->
      <h3>
        Vite - це надзвичайно швидкий інструмент для збірки фронтенду, який забезпечує роботу веб-додатків наступного покоління.
      </h3>

      <!-- CTA Buttons -->
      <div class="hero__actions">
        <a href="/guide/" class="btn btn--primary">Почати</a>
        <a
