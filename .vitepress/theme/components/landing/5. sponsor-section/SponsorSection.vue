...
<template>
  <div class="sponsor-section">
    ...
    <img
      ...
      height="55"
    />
    <h2>Безкоштовний та з відкритим вихідним кодом</h2>
    <h4>
      Vite має ліцензію MIT і завжди буде безкоштовним та з відкритим вихідним кодом. Це стало можливим завдяки нашим учасникам та цим компаніям:
    </h4>
